...
%{
  ...
  int yylex(void);
  	  ...
  	  //Funktionskontext. Enthält den Namen der Funktion, wenn er sich in ihr befindet. Anonsten wird der String '___#nktx&' abgespeichert.
  	  //Der Kryptische Name wurde gewählt, da es teilweise zu Problemen mit dem NULL-Wert kam.
...
function_def
	:  /* empty */  {  
		...
		//Feature wurde entfernt, da es doch möglich ist, funktionen zu definieren ohne sie zu deklarieren
...
function_declaration
	...
	| function_header function_parameter_list PARA_CLOSE { 
    	sym_function_t func;
	 	func.returnType = $1.vof.symVariable.varType;
		func.protOrNot = proto; //TODO: An welcher stelle muss 'no' für protOrNot gesetzt werden???
